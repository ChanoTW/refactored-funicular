...
public class Land26Jamshil extends Land000{

	public Land26Jamshil(String name, int owner, int price, int building, int hotel, int pass, int passBuilding,
	...
	public String toString() {
		return "Land26Jamshil [getName()=" + getName() + ", getOwner()=" + getOwner() + ", getPrice()=" + getPrice()
