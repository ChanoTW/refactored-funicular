...
public class Land14Ahyeon extends Land000 {

	public Land14Ahyeon(String name, int owner, int price, int building, int hotel, int pass, int passBuilding,
	...
	public String toString() {
		return "Land14Ahyeon [getName()=" + getName() + ", getOwner()=" + getOwner() + ", getPrice()=" + getPrice()
