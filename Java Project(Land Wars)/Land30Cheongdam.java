...
public class Land30Cheongdam extends Land000{

	public Land30Cheongdam(String name, int owner, int price, int building, int hotel, int pass, int passBuilding,
	...
	public String toString() {
		return "Land30Cheongdam [getName()=" + getName() + ", getOwner()=" + getOwner() + ", getPrice()=" + getPrice()
