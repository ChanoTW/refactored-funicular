...
public class Land11Nonhyeon extends Land000 {

	public Land11Nonhyeon(String name, int owner, int price, int building, int hotel, int pass, int passBuilding,
	...
	public String toString() {
		return "Land11Nonhyeon [getName()=" + getName() + ", getOwner()=" + getOwner() + ", getPrice()=" + getPrice()
